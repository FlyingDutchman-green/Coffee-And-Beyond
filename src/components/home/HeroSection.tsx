...
import { ArrowRight, Coffee, QrCode, Play } from "lucide-react";
            ...
            <div className="lg:col-span-7 space-y-8">
              <div className="flex flex-wrap items-center gap-2">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1 bg-[#F7F7F5] border border-border-subtle rounded-md text-xs font-semibold text-text-primary hover:bg-white transition-colors cursor-pointer"
                >
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-2">
                ...
                <button
                  type="button"
                  onClick={() => setIsVideoDialogOpen(true)}
                  className="inline-flex items-center justify-center gap-2 px-5 py-3.5 bg-canvas-secondary text-text-primary font-semibold text-sm border border-border-subtle rounded-md hover:bg-white transition-colors cursor-pointer"
                >
                  <Play className="w-4 h-4 text-accent-warm fill-accent-warm" />
