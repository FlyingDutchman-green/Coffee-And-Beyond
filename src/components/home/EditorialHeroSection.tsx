...
export function EditorialHeroSection() {
  ...
  const badgeText =
    heroEditorial.badgeText || DEFAULT_SETTINGS.heroEditorial.badgeText;
  const headline =
    heroEditorial.headline || DEFAULT_SETTINGS.heroEditorial.headline;
  const subheadline =
    heroEditorial.subheadline || DEFAULT_SETTINGS.heroEditorial.subheadline;
  const poster1x1Url = useMediaUrl(
  ...
  const secondaryCtaText =
    heroEditorial.secondaryCtaText ||
    DEFAULT_SETTINGS.heroEditorial.secondaryCtaText;
  const secondaryCtaLink =
    heroEditorial.secondaryCtaLink ||
    DEFAULT_SETTINGS.heroEditorial.secondaryCtaLink;
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center py-12 lg:py-20">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            {/* Dual Action CTAs (2 Clean Buttons Only) */}
          ...
          {/* Right Column: Clean 1:1 Aspect Ratio Square Photo (Pure Aesthetic Photography) */}
          <div className="lg:col-span-5">
            <FadeInView delay={0.2} direction="up" distance={28} duration={0.8}>
              <div className="aspect-square w-full rounded-2xl sm:rounded-3xl overflow-hidden border border-[#E7E7E3] shadow-xs relative bg-[#F7F7F5] group">
